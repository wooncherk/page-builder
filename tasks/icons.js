...
function getIconNames() {
    ...
    const tsFiles = [...getFilesInPath('./src/app', '.ts'), ...getFilesInPath('./src/common', '.ts'), ...getFilesInPath('./../server/public/builder/elements', '.html')];
    ...
    //TODO: import names from menus php config
    names = names.concat([
        'home',
        'multiple-choice',
        'www',
